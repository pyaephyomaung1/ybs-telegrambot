...
export const stops: StopSeed[] = [
  { id: 1, name: 'Pae Ku River Road', townshipId: 2 },
  { id: 2, name: 'Aye Yar Wun Road', townshipId: 2 },
  { id: 3, name: 'Kyway Ma', townshipId: 9 },
  { id: 4, name: 'Yadana Road', townshipId: 9 },
  { id: 5, name: 'Thanlyin Bridge Road', townshipId: 9 },
  { id: 6, name: 'Thar Kay Ta Circle', townshipId: 11 },
  { id: 7, name: 'Kyaut Tine', townshipId: 11 },
  { id: 8, name: 'Min Nandar Road', townshipId: 11 },
  { id: 9, name: 'Mahar Bandoola Bridge', townshipId: 38 },
  { id: 10, name: 'Anawrahta Road', townshipId: 38 },
  { id: 11, name: 'Sule', townshipId: 38 },
  { id: 12, name: 'Mahar Bandula Road', townshipId: 1 },
  { id: 13, name: 'Yadanarbon Road', townshipId: 6 },
  { id: 14, name: 'Kyan Sit Thar Road', townshipId: 6 },
  { id: 15, name: 'Hlawgar Road', townshipId: 19 },
  { id: 16, name: 'Pyi Htaung Su Road', townshipId: 7 },
  { id: 17, name: 'South North Intersection', townshipId: 5 },
  { id: 18, name: 'San Pya Market', townshipId: 5 },
  { id: 19, name: 'Zawana', townshipId: 11 },
  { id: 20, name: 'Tamwe (Bali)', townshipId: 11 },
  { id: 21, name: 'Mingalar Market', townshipId: 11 },
  { id: 22, name: 'Thein Phyu', townshipId: 1 },
  { id: 23, name: 'Hledan', townshipId: 43 },
  { id: 24, name: 'Hledan Khine Shwe War', townshipId: 43 },
  { id: 25, name: 'Baho Road', townshipId: 19 },
  { id: 26, name: 'Insein Garden', townshipId: 19 },
  { id: 27, name: 'YTU', townshipId: 19 },
  { id: 28, name: 'Tha Mine Intersection', townshipId: 19 },
  { id: 29, name: 'San Pya Market', townshipId: 40 },
  { id: 30, name: 'Zawana', townshipId: 5 },
];
